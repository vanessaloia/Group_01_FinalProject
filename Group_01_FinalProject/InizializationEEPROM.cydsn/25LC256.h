...
/*
* \ Read the STATUS registrer of the device.
*
*\ Status of the device (1 unsigned byte)
*/
uint8_t EEPROM_readStatus(void);

/*
*\ Issue the WRITE ENABLE (WREN) instruction.
*/
