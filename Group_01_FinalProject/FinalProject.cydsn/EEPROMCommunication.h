...
/* [] END OF FILE */
    ...
    volatile uint8_t Flag_Cell;
    
    uint8_t EEPROM_Data[192/*EEPROM_PACKET_BYTES * (WATERMARK_LEVEL + 1)*/];
    uint8_t EEPROM_Data_read[192/*EEPROM_PACKET_BYTES * (WATERMARK_LEVEL + 1)*/];
