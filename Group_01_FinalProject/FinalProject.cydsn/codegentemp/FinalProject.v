...
module ADC_DelSig_v3_30_4 (
	...
	cy_clock_v1_0
		#(.id("88772921-9b5f-43a5-9269-87d30b68541c/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("88772921-9b5f-43a5-9269-87d30b68541c/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
...
module top ;
    ...
    cy_annotation_universal_v1_0 KIT_059 (
        .connect({
            Net_436,
            Net_437,
            Net_438,
    ...
    defparam LED.comp_name = "LED_sm1_v1_0";
    defparam LED.port_names = "T1, T2";
    ...
    defparam R_1.comp_name = "Resistor_sm1_v1_0";
    ...
    UART_v2_50_0 UART (
        ...
        .reset(1'b0),
        .rx(Net_235),
        .tx_interrupt(Net_344),
        .rx_interrupt(Net_345),
        .tx_data(Net_346),
        .tx_clk(Net_347),
        .rx_data(Net_348),
        .rx_clk(Net_349));
	...
	cy_psoc3_pins_v1_10
		#(.id("ccc6b01e-95b8-4d07-9674-c0216155bcb8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e4366407-1d27-4e99-a4da-bb111660251b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    SPI_Master_v2_50_3 SPIM (
        ...
        .clock(1'b0),
        .reset(1'b0),
        .rx_interrupt(Net_220),
        .sdat(Net_221),
        .tx_interrupt(Net_222));
	...
	cy_psoc3_pins_v1_10
		#(.id("085f84da-d899-4e39-9b0c-851da5c05a23"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Temperature_Sensor_net;
	wire [0:0] tmpFB_0__Temperature_Sensor_net;
	wire [0:0] tmpIO_0__Temperature_Sensor_net;
	wire [0:0] tmpINTERRUPT_0__Temperature_Sensor_net;
	electrical [0:0] tmpSIOVREF__Temperature_Sensor_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Temperature_Sensor
		 (.oe(tmpOE__Temperature_Sensor_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Temperature_Sensor_net[0:0]}),
		  .analog({Net_427}),
		  .io({tmpIO_0__Temperature_Sensor_net[0:0]}),
		  .siovref(tmpSIOVREF__Temperature_Sensor_net),
		  .interrupt({tmpINTERRUPT_0__Temperature_Sensor_net[0:0]}),
		  .annotation({Net_428}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Temperature_Sensor_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__INT_LIS3DH_net;
	wire [0:0] tmpIO_0__INT_LIS3DH_net;
	wire [0:0] tmpINTERRUPT_0__INT_LIS3DH_net;
	electrical [0:0] tmpSIOVREF__INT_LIS3DH_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		INT_LIS3DH
		 (.oe(tmpOE__INT_LIS3DH_net),
		  .y({1'b0}),
		  .fb({Net_487}),
		  .io({tmpIO_0__INT_LIS3DH_net[0:0]}),
		  .siovref(tmpSIOVREF__INT_LIS3DH_net),
		  .interrupt({tmpINTERRUPT_0__INT_LIS3DH_net[0:0]}),
		  .annotation({Net_490}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__INT_LIS3DH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
